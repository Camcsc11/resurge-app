...
export default function QAHistory({ clips }: QAHistoryProps) {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">QA Review History</h1>
        <p className="text-gray-600 mt-2">
          Clips that have been reviewed
        </p>
      </div>

      {clips.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
          <p className="text-gray-500">No reviewed clips yet</p>
        </div>
      ) : (
