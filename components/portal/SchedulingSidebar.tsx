...
import { Calendar, CheckSquare, LogOut, ChevronRight } from "lucide-react";
...
export default function SchedulingSidebar({ profile }: SchedulingSidebarProps) {
  ...
  const navItems = {
    admin: [
      { label: "Schedule", href: "/portal/scheduling/admin", icon: Calendar },
      { label: "Tasks", href: "/portal/scheduling/admin/tasks", icon: CheckSquare },
    ],
    employee: [
      { label: "My Schedule", href: "/portal/scheduling/employee", icon: Calendar },
      { label: "My Tasks", href: "/portal/scheduling/employee/tasks", icon: CheckSquare },
    ],
  };
